...
| 1.3 | 2026-09-03 | Sandeco (correção com Claude) | O commit da v1.2.59 ficou no branch `feat/permissao-edicao-legado` e nunca chegou ao `main`; a 1.3.1 foi publicada só com os templates. Implementação aplicada ao `main` na v1.3.2 (BUG-20260903-W2RC) |
