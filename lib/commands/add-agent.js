...
const AGENT_LABELS = {
  ...
  'reversa-security-auditor': 'Security Auditor: vulnerability scan, secrets detection, auth audit, OWASP review',
  'reversa-performance-analyst': 'Performance Analyst: hot path detection, N+1 queries, algorithm complexity, resource leaks',
};
