...
import { runInstallPrompts, MIGRATION_AGENT_IDS, TRANSLATOR_AGENT_IDS, FORWARD_AGENT_IDS, PRICING_AGENT_IDS, DOCS_AGENT_IDS, NEW_PROJECT_AGENT_IDS } from '../installer/prompts.js';
...
export default async function install(args) {
  ...
  try {
    ...
    // Install the entry file for each engine (deduplicates shared files)
