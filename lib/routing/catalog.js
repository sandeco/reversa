...
const READ_ONLY_AGENTS = new Set(['reversa-agents-help', 'reversa-debugger-review']);
const NON_ESCALATING_AGENTS = new Set(['reversa-debugger-review']);
...
export const AGENT_CATALOG = Object.freeze(Object.fromEntries(
  Object.entries(GROUPS).flatMap(([computeClass, agentIds]) =>
    agentIds.map((id) => [id, Object.freeze({
      ...
      escalatable: !NON_ESCALATING_AGENTS.has(id),
    })])
  )
));
